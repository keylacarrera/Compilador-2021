namespace Compilador_2021
{
    ...
    public partial class Form1 : Form
    {
        ...
        #region Estructura de Variables
        public void estruc_comparacion()
        {
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$|^[0-9]+$[0-9]?|^\".*\"$"))
            {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$"))
                {
                    ...
                    if (existe == "no")
                    {
                        dataGridView2.Rows.Add("ERROR", "NOMBRE DE VARIABLE NO DECLARADA" + " FILA: " + 
                            num_linea[recorrido] + " COLUMNA: " + num_columna[recorrido_sum]);
                    }
                }
        ...
        public void estruc_comparacion_mientras()
        {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^[<|>]$|^==$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$|^[0-9]+$[0-9]?|^\".*\"$"))
                    {
                        ...
                        else
                        {
                            ...
                            {
                                dataGridView2.Rows.Add("CORRECTA", " COMPARACION" + " FILA: " + num_linea[recorrido_sum]);
                                pasar_a_c[pasos_pasar_a_c] = "while ( " + lexi_a_sint[recorrido_sum - 2] + " " + 
                                    lexi_a_sint[recorrido_sum - 1] + " " + lexi_a_sint[recorrido_sum] + " )" + "\n";
                                pasos_pasar_a_c += 1;
                            }
                            else
                            {
                    ...
                    {
                        dataGridView2.Rows.Add("ERROR", "SE ESPERABA VARIABLE, CADENA O NUMERO" + " FILA: " + num_linea[recorrido_sum] +
                            " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                    }
                }
                else
                {
                    dataGridView2.Rows.Add("ERROR", "SE ESPERABA UN COMPARADOR" + " FILA: " + num_linea[recorrido_sum] +
                        " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                }
            ...
            {
                dataGridView2.Rows.Add("ERROR", "SE ESPERABA UNA VARIABLE, CADENA O NUMERO" + " FILA: " + 
                    num_linea[recorrido_sum] + " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
            }
        ...
        public void estruc_ver_dentro_de_si()
        {
            ...
            {
                if ((lexi_a_sint[recorrido_sum - 2] != "proceso" || lexi_a_sint[recorrido_sum - 1] != "proceso") & 
                    proceso_correcto == "0" & ya_imprimio_no_hay_proc == "0")
                {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$"))
                {
                    ...
                    {
                        dataGridView2.Rows.Add("ERROR", "SE ESPERABA PUNTO Y COMA" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " + 
                            num_columna[recorrido_sum]); recorrido_sum -= 1;
                    }

                }
                else
                {
                    dataGridView2.Rows.Add("ERROR", "SE ESPERABA UNA CADENA" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " +
                        num_columna[recorrido_sum]); recorrido_sum -= 1;
                }
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "#"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^[0-9]+$[0-9]?"))
                        {
                            ...
                            {
                                dataGridView2.Rows.Add("ERROR", "SE ESPERABA PUNTO Y COMA" + " FILA: " + num_linea[recorrido] + " COLUMNA: " +
                                    num_columna[recorrido_sum]); recorrido_sum -= 1;
                            }
                        }
                        else
                        {
                            dataGridView2.Rows.Add("ERROR", "SE ESPERABA UN NUMERO" + " FILA: " + num_linea[recorrido] + " COLUMNA: " + 
                                num_columna[recorrido_sum]); recorrido_sum -= 1;
                        }
                    }
                    else
                    {
                        dataGridView2.Rows.Add("ERROR", "SE ESPERABA ASIGNADOR" + " FILA: " + num_linea[recorrido] + " COLUMNA: " + 
                            num_columna[recorrido_sum]); recorrido_sum -= 1;
                    }
                }
                else
                {
                    dataGridView2.Rows.Add("ERROR", "SE ESPERABA VARIABLE" + " FILA: " + num_linea[recorrido] + " COLUMNA: " + 
                        num_columna[recorrido_sum]); recorrido_sum -= 1;
                }
                recorrido = recorrido_sum;
            }
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "#"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^[0-9]+$[0-9]?"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                            {
                                dataGridView2.Rows.Add("ERROR", "DECLARACION --> entero <--DEBE IR ANTES DE --> proceso ; <-- " +
                                    "FILA: " + num_linea[recorrido]);
                            }
                            else
                            {
                                dataGridView2.Rows.Add("ERROR", "DECLARACION --> entero <--DEBE IR ANTES DE --> proceso ; <-- " + 
                                    "FILA: " + num_linea[recorrido]); recorrido_sum -= 1;
                            }
                        }
                        else
                        {
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "cadena"))
            {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "#"))
                    {
                        ...
                        {
                            dataGridView2.Rows.Add("ERROR", "SE ESPERABA UNA CADENA" + " FILA: " + num_linea[recorrido] + " COLUMNA: " +
                                num_columna[recorrido_sum]); recorrido_sum -= 1;
                        }
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^var[(0-9)?]$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "#"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                            {
                                dataGridView2.Rows.Add("ERROR", "DECLARACION --> cadena <--DEBE IR ANTES DE --> proceso ; <-- " +
                                    "FILA: " + num_linea[recorrido]);
                            }
                            else
                            {
                        ...
                        {
                            dataGridView2.Rows.Add("ERROR", "DECLARACION --> cadena <--DEBE IR ANTES DE --> proceso ; <-- " + "FILA: " +
                                num_linea[recorrido]); recorrido_sum -= 1;
                        }
        ...
        public void estruc_ver()
        {
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "ver"))
            {
                if ((lexi_a_sint[recorrido_sum - 2] != "proceso" || lexi_a_sint[recorrido_sum - 1] != "proceso") & proceso_correcto == "0" &
                    ya_imprimio_no_hay_proc == "0")
                {
        ...
        public void estruc_verx()
        {
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "ver"))
            {
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "^\".*\"$"))
                {
                    ...
                    if (Regex.IsMatch(lexi_a_sint[recorrido_sum], ";"))
                    {
                        dataGridView2.Rows.Add("ERROR", "ESTRUCTURA --> ver <--DEBE IR DESPUES DE --> proceso ; <-- " + "FILA: " +
                            num_linea[recorrido]);
                    }
                    else
                    {
        ...
        public void estruc_si()
        {
            ...
            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "si"))
            {
                if ((lexi_a_sint[recorrido_sum - 2] != "proceso" || lexi_a_sint[recorrido_sum - 1] != "proceso") &
                    proceso_correcto == "0" & ya_imprimio_no_hay_proc == "0")
                {
                    dataGridView2.Rows.Add("ERROR", "SE ESPERABA INICIALIZACION: --> proceso ; <--" + " ANTES DE FILA: " +
                        num_linea[recorrido_sum]);
                    ya_imprimio_no_hay_proc = "1";
                }
                recorrido_sum += 1;
                if (lexi_a_sint[recorrido_sum].Equals("("))
                {
                    ...
                    if (lexi_a_sint[recorrido_sum].Equals(")"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "{"))
                        {
                            ...
                            {
                                dataGridView2.Rows.Add("ERROR", "SE ESPERABA CIERRE DE LLAVE" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " +
                                    num_columna[recorrido_sum]); recorrido_sum -= 1;
                            }
                        ...
                        {
                            dataGridView2.Rows.Add("ERROR", "SE ESPERABA APERTURA DE LLAVE" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " + 
                                num_columna[recorrido_sum]); recorrido_sum -= 1;
                        }
                    ...
                    {
                        dataGridView2.Rows.Add("ERROR", "SE ESPERABA CIERRE DE PARENTESIS" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " +
                            num_columna[recorrido_sum]); recorrido_sum -= 1;
                    }
                }
                else
                {
                    dataGridView2.Rows.Add("ERROR", "SE ESPERABA APERTURA DE PARENTESIS" + " FILA: " + num_linea[recorrido_sum] + " COLUMNA: " +
                        num_columna[recorrido_sum]); recorrido_sum -= 1;
                }
                ...
                if (lexi_a_sint[recorrido_sum].Equals("("))
                {
                    ...
                    if (lexi_a_sint[recorrido_sum].Equals(")"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "{"))
                        {
                            ...
                            if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "}"))
                            {
                                dataGridView2.Rows.Add("ERROR", "ESTRUCTURA --> si <--DEBE IR DESPUES DE --> proceso ; <-- " + "FILA: " +
                                    num_linea[recorrido_sum]);
                            }
                            else
                            {
                                dataGridView2.Rows.Add("ERROR", "ESTRUCTURA --> si <--DEBE IR DESPUES DE --> proceso ; <-- " + "FILA: " +
                                    num_linea[recorrido_sum]); recorrido_sum -= 1;
                            }
                ...
                if (lexi_a_sint[recorrido_sum].Equals("("))
                {
                    ...
                    if (lexi_a_sint[recorrido_sum].Equals(")"))
                    {
                        ...
                        if (Regex.IsMatch(lexi_a_sint[recorrido_sum], "{"))
                        {
                            ...
                            {
                                dataGridView2.Rows.Add("ERROR", "SE ESPERABA CIERRE DE LLAVE" + " FILA: " + num_linea[recorrido_sum] +
                                    " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                            }
                        ...
                        {
                            dataGridView2.Rows.Add("ERROR", "SE ESPERABA APERTURA DE LLAVE" + " FILA: " + num_linea[recorrido_sum] +
                                " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                        }
                    ...
                    {
                        dataGridView2.Rows.Add("ERROR", "SE ESPERABA CIERRE DE PARENTESIS" + " FILA: " + num_linea[recorrido_sum] +
                            " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                    }
                }
                else
                {
                    dataGridView2.Rows.Add("ERROR", "SE ESPERABA APERTURA DE PARENTESIS" + " FILA: " + num_linea[recorrido_sum] +
                        " COLUMNA: " + num_columna[recorrido_sum]); recorrido_sum -= 1;
                }
        ...
        private void compilar()
        {
            ...
            if (contador_error_compilar == 0)
            {
               ...
               // using (StreamWriter writer = new StreamWriter("C:\\Users\\keyla\\Desktop\\Ejemplos Proyecto 3.1\\Ejemplos Incorrectos\\Ejemplo 1.txt", false))
        ...
        public void Sintactico()
        {
            ...
            for (recorrido = 0; recorrido < lexi_a_sint.Length; recorrido++)
            {
                ...
                if (inicio_correcto == "0")
                {
                    if (recorrido == 0)
                    {
                        dataGridView2.Rows.Add("ERROR", "SE ESPERABA INICIALIZACION: --> inicio ; <-- " + "ANTES DE FILA: " +
                            num_linea[recorrido]);
                ...
                if (Regex.IsMatch(lexi_a_sint[recorrido], "proceso"))
                {
                    ...
                    {
                        dataGridView2.Rows.Add("ERROR", "SE ESPERABA PUNTO Y COMA" + " FILA: " + num_linea[recorrido] +
                            " COLUMNA: " + num_columna[recorrido]);
                    }
                }
        ...
        #region Barra de Navegadores
        private void CompilaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            analizarLexico();
            compilar();
        }
        private void nuevoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (richTextBox1.Modified == true)
                {
                    ...
                    answer = MessageBox.Show("Guardar documento actual antes de crear el nuevo documento?",
                        "No se ha guardado el documento", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    if (answer == System.Windows.Forms.DialogResult.No)
                    {
                        ArchivoActual = "";
                        this.Text = "Editor: Nuevo Documento";
                    ...
                    {
                        guardarComoCtrlSToolStripMenuItem_Click(this, new EventArgs());
                        richTextBox1.Modified = false;
                        richTextBox1.Clear();
                        ArchivoActual = "";
                        this.Text = "Editor: Nuevo Documento";
        ...
        {
            open.Filter = "Rich Text Files|*.rtf|Text Files|*.txt|HTML Files|*.htm|All Files|*.*";
        ...
        {
            save.Filter = "Rich Text Files|*.rtf|Text Files|*.txt|HTML Files|*.htm|All Files|*.*";
        ...
        private void guardarComoCtrlSToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                save.DefaultExt = "txt";
                ...
                if (save.ShowDialog() == DialogResult.OK)
                {
                    ...
                    string strExt;
                    strExt = System.IO.Path.GetExtension(save.FileName);
                    ...
                    else
                    {
                        ...
                        txtWriter = new System.IO.StreamWriter(save.FileName);
                    ...
                    ArchivoActual = save.FileName;
                    richTextBox1.Modified = false;
                    this.Text = "Editor: " + ArchivoActual.ToString();
                    // MessageBox.Show(ArchivoActual.ToString() + " Guardar.", " Guardar Archivo");
                }
                else
                {
                    MessageBox.Show("Guardar archivo de solicitud cancelada por el usuario. ", " Cancelado");
                }
            }
            catch (Exception ex)
            {
        ...
        private void salirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    System.Windows.Forms.DialogResult answer;
                    answer = MessageBox.Show("Guarde este documento antes de cerrar?", " No se ha guardado el documento",
        ...
        private void copiarCtrlSToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                richTextBox1.Copy();
            ...
            {
                MessageBox.Show("No se puede copiar el contenido del documento.", " Electrica", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void pegarCtrlSToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            try
            {
                richTextBox1.Paste();
            ...
            {
                MessageBox.Show("No se puede copiar el contenido del portapapeles al documento.", " documento",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void cortarCtrlSToolStripMenuItem2_Click(object sender, EventArgs e)
        {
            try
            {
                richTextBox1.Cut();
            ...
            {
                MessageBox.Show("No se puede cortar el contenido del documento.", " Atencion",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void deshacerCtrlSToolStripMenuItem3_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void rehacerCtrlSToolStripMenuItem4_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            dataGridView1.Rows.Clear();
            label5.Text = Convert.ToString(richTextBox1.Lines.Length);
